...
public class TitleSlider : BaseSlider
{
    TitleFastener titleFastener;    //親Fastener
    //=====================================================
    void Start()
    {
        titleFastener = transform.parent.GetComponent<TitleFastener>();
    }
    //-----------------------------------------------------
    //  持ち手をタッチ方向へ回転
    //-----------------------------------------------------
