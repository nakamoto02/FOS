...
public class SelectSlider : BaseSlider
{
    SelectFastener selectFastener;  //親Fastener
    //=====================================================
    void Start()
    {
        selectFastener = transform.parent.GetComponent<SelectFastener>();
    }
    //-----------------------------------------------------
    //  持ち手をタッチ方向へ回転
    //-----------------------------------------------------
    ...
    public override void SliderTouchDown(int id)
    {
        ...
        selectFastener.IsTouch(isTouch);
    }
    //-----------------------------------------------------
    //  離した時
    //-----------------------------------------------------
